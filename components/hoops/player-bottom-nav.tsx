...
export function PlayerBottomNav({ playerName }: PlayerBottomNavProps) {
  ...
  return (
    <>
      ...
      >
        <div className="mx-auto flex h-24 max-w-7xl items-center justify-around px-2 md:justify-start md:gap-1 md:px-4">
          {items.map(({ href, label, icon: Icon }) => {
            ...
            return (
              <Link
                ...
                href={href}
                className={cn(
                  'flex min-w-[76px] flex-col items-center justify-center gap-2 py-3 text-xs transition-colors md:min-w-0 md:flex-row md:gap-2 md:rounded-md md:px-3 md:py-2 md:text-sm',
                  isActive
              ...
              >
                <Icon className="h-8 w-8 shrink-0 md:h-4 md:w-4" />
                <span>{label}</span>
              </Link>
            )
          })}
          ...
          <button
            ...
            className="flex min-w-[76px] flex-col items-center justify-center gap-2 py-3 text-xs transition-colors text-gray-500 hover:text-gray-900 hover:bg-gray-100 md:min-w-0 md:flex-row md:gap-2 md:rounded-md md:px-3 md:py-2 md:text-sm"
          >
            <MoreHorizontal className="h-8 w-8 shrink-0 md:h-4 md:w-4" />
            <span>More</span>
          </button>
        </div>
      </nav>
